...
connect_debug_port u_ila_0/probe0 [get_nets [list {core_inst/btn[0]} {core_inst/btn[1]} {core_inst/btn[2]} {core_inst/btn[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 8 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {core_inst/tx_fifo_udp_payload_axis_tdata[0]} {core_inst/tx_fifo_udp_payload_axis_tdata[1]} {core_inst/tx_fifo_udp_payload_axis_tdata[2]} {core_inst/tx_fifo_udp_payload_axis_tdata[3]} {core_inst/tx_fifo_udp_payload_axis_tdata[4]} {core_inst/tx_fifo_udp_payload_axis_tdata[5]} {core_inst/tx_fifo_udp_payload_axis_tdata[6]} {core_inst/tx_fifo_udp_payload_axis_tdata[7]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 8 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list {core_inst/tx_udp_payload_axis_tdata[0]} {core_inst/tx_udp_payload_axis_tdata[1]} {core_inst/tx_udp_payload_axis_tdata[2]} {core_inst/tx_udp_payload_axis_tdata[3]} {core_inst/tx_udp_payload_axis_tdata[4]} {core_inst/tx_udp_payload_axis_tdata[5]} {core_inst/tx_udp_payload_axis_tdata[6]} {core_inst/tx_udp_payload_axis_tdata[7]}]]
